...
import { Toast, Progress, List, Radio, WhiteSpace, Button } from 'antd-mobile';
...
function Questions(props) {
    ...
    const progress = (index + 1) * 100 / (questions.length);
    ...
    return (
        <Wrap>
            <Ques warning={warning}>{`[${index + 1}/${questions.length}] ${ques.title}`}</Ques>
